...
import os
project_root = os.getenv("THUNDERKITTENS_ROOT", 'accelerated_scan/tk')
...
def jit_build(name, debug=False, gpu_type='4090'):
    _cuda_flags  = ['-U__CUDA_NO_HALF_OPERATORS__', '-U__CUDA_NO_HALF_CONVERSIONS__',
                    "-U__CUDA_NO_BFLOAT16_OPERATORS__", "-U__CUDA_NO_BFLOAT16_CONVERSIONS__",
                    '--generate-line-info', '--restrict', 
                    f"-I {project_root}"]
...
def cuda_extension(name, debug, gpu_type='4090'): 
    _cuda_flags  = [
